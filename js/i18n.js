(() => {
  ...
  const translations = {
    en: {
      ...
      'nodes-workbench-windows-capture-preview': 'Windows Blender node-group capture',
      ...
      'nodes-dialog-capture-preview-alt': 'Windows Blender node-group capture: {name} from {sourceBlend}',
      ...
      'nodes-dialog-capture-preview-caption': 'Windows Blender node-group capture of {name} from declared source blend {sourceBlend}.',
      ...
      'nodes-dialog-view-declared-source-blend': 'View declared source blend',
    ...
    zh: {
      ...
      'nodes-workbench-windows-capture-preview': 'Windows Blender 节点组截图',
      'nodes-workbench-preview-version': 'Blender {version}',
      'nodes-workbench-preview-dimensions': '{width} × {height} px',
      ...
      'nodes-dialog-capture-preview-alt': 'Windows Blender 节点组截图：{name}，来源 {sourceBlend}',
      'nodes-dialog-preview-unavailable': '预览不可用：{name}',
      'nodes-dialog-preview-caption': 'Blueish 档案中的官方使用示例。',
      'nodes-dialog-capture-preview-caption': '来自已声明源 .blend {sourceBlend} 的 {name} Windows Blender 节点组截图。',
      ...
      'nodes-dialog-view-declared-source-blend': '查看已声明的源 .blend',
