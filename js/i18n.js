(() => {
  ...
  const translations = {
    en: {
      ...
      'nodes-workbench-download-note': 'This download is the complete Blueish node asset package.',
      'nodes-workbench-download-assets': 'Download complete Blueish node assets',
    ...
    zh: {
      ...
      'nodes-workbench-download-note': '此下载为 Blueish 完整节点资产包。',
      'nodes-workbench-download-assets': '下载 Blueish 完整节点资产',
      'nodes-workbench-record-counter': '{code} · {index} / {total}',
