(() => {
  ...
  const translations = {
    en: {
      ...
      'nodes-card-thumbnail-alt': '{name} asset thumbnail',
      'nodes-card-thumbnail-fallback': 'Thumbnail unavailable',
      'nodes-card-source-visual-unavailable': 'Source visual unavailable',
      'nodes-card-source-visual-unavailable-description': 'No verified source visual is available.',
      'nodes-card-description-unavailable': 'No source description is available.',
      ...
      'nodes-workbench-previous': 'Previous node',
      'nodes-workbench-next': 'Next node',
      'nodes-workbench-copy-link': 'Copy Blueish remote asset library URL',
      'nodes-workbench-copy-complete': 'Blueish remote asset library URL copied',
      'nodes-workbench-download-note': 'This download is the complete pack of 518 node groups + 15 objects.',
      'nodes-workbench-download-assets': 'Download complete node assets',
      'nodes-workbench-record-counter': '{code} · {index} / {total}',
      'nodes-workbench-official-preview': 'Official node example',
      'nodes-workbench-windows-capture-preview': 'Node preview',
      'nodes-workbench-preview-version': 'Blender {version}',
      'nodes-workbench-preview-dimensions': '{width} × {height} px',
      ...
      'nodes-dialog-capture-preview-alt': 'Node preview: {name}',
      ...
      'nodes-dialog-capture-preview-caption': 'Windows Blender node-group capture · {name} · {sourceBlend}',
      ...
      'nodes-dialog-download-note': 'This node is included in the linked source file; it is not presented as a separate single-node file.',
      'nodes-dialog-download-owning': 'Download source file',
      'nodes-dialog-provenance-copy': 'Source details are retained in the archive.',
      ...
      'tutorials-image-zoom': 'View full-size image',
      'tutorials-image-zoom-close': 'Close full-size image',
    ...
    zh: {
      ...
      'nodes-card-thumbnail-alt': '{name} 资产缩略图',
      'nodes-card-thumbnail-fallback': '缩略图不可用',
      'nodes-card-source-visual-unavailable': '源图像不可用',
      'nodes-card-source-visual-unavailable-description': '当前没有可核验的来源图像。',
      'nodes-card-description-unavailable': '没有可用的来源说明。',
      'nodes-subtype': '子类',
      ...
      'nodes-workbench-previous': '上一个节点',
      'nodes-workbench-next': '下一个节点',
      'nodes-workbench-copy-link': '复制 Blueish 远程资产库链接',
      'nodes-workbench-copy-complete': 'Blueish 远程资产库链接已复制',
      'nodes-workbench-download-note': '此下载为站点收录的 518 个节点组 + 15 个物体完整 blend 包。',
      'nodes-workbench-download-assets': '下载完整节点资产',
      'nodes-workbench-record-counter': '{code} · {index} / {total}',
      'nodes-workbench-official-preview': '官方节点示例',
      'nodes-workbench-windows-capture-preview': '节点预览',
      'nodes-workbench-preview-version': 'Blender {version}',
      'nodes-workbench-preview-dimensions': '{width} × {height} px',
      ...
      'nodes-dialog-capture-preview-alt': '节点预览：{name}',
      'nodes-dialog-preview-unavailable': '预览不可用：{name}',
      'nodes-dialog-preview-caption': 'Blueish 档案中的官方使用示例。',
      'nodes-dialog-capture-preview-caption': 'Windows Blender 节点组截图 · {name} · {sourceBlend}',
      ...
      'nodes-dialog-download-note': '此节点包含在已链接的源文件中；它并非单独提供的单节点文件。',
      'nodes-dialog-download-owning': '下载源文件',
      'nodes-dialog-provenance-copy': '来源详情保留在档案中。',
      ...
      'tutorials-image-zoom': '查看原图',
      'tutorials-image-zoom-close': '关闭原图',
