(() => {
  ...
  const translations = {
    en: {
      ...
      'nodes-workbench-copy-link': 'Copy node link',
      'nodes-workbench-copy-complete': 'Node link copied',
      ...
      'nodes-dialog-view-declared-source-blend': 'View capture source',
    ...
    zh: {
      ...
      'nodes-workbench-copy-link': '复制节点链接',
      'nodes-workbench-copy-complete': '节点链接已复制',
      'nodes-workbench-record-counter': '{code} · {index} / {total}',
      ...
      'nodes-dialog-view-declared-source-blend': '查看截图来源',
